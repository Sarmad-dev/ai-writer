...
export function AuthPage({ flow }: AuthPageParams) {
    ...
    try {
      ...
      if (data) {
        ...
        if ("user" in data && data.user && typeof data.user === "object") {
          ...
          // Handle redirect case - redirect to the OAuth provider
  ...
  return (
    <main className="relative md:h-screen md:overflow-hidden lg:grid lg:grid-cols-2">
      <div className="relative hidden h-full flex-col border-r bg-secondary p-10 lg:flex dark:bg-secondary/20">
        ...
        <div className="z-10 mt-auto"></div>
        ...
        <div className="mx-auto space-y-4 sm:w-sm">
          ...
          <div className="flex flex-col space-y-1">
            ...
            <p className="text-base text-muted-foreground">
              login or create your AI writing account.
            </p>
          </div>
